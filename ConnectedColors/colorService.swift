...
extension ColorService: MCNearbyServiceAdvertiserDelegate{
    ...
    func advertiser(_ advertiser: MCNearbyServiceAdvertiser, didReceiveInvitationFromPeer peerID: MCPeerID, withContext context: Data?, invitationHandler: @escaping (Bool, MCSession?) -> Void) {
        NSLog("%@", "didReceieInvitationFromPeer \(peerID)")
        invitationHandler(true,self.session)

    }
    
    
    func advertiser(_advertiser: MCNearbyServiceAdvertiser,didNotStartdvertising error: Error){
...
extension ColorService: MCNearbyServiceBrowserDelegate{
    ...
    func browser(_ browser: MCNearbyServiceBrowser, foundPeer peerID: MCPeerID, withDiscoveryInfo info: [String : String]?) {
        ...
        //Automatically finds and invites the peer. Might change to manually adding peer in the future
