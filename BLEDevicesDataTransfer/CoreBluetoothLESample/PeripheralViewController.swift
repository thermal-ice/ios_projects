...
class PeripheralViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //Creates the peripheral manager, not much else
    ...
    //MARK: Adding service here, implement when there is error adding a service.
//    private func peripheralManager(_ peripheral: CBPeripheralManager, didAdd service: CBService, error: Error?) {
//        <#code#>
//    }
}
...
extension PeripheralViewController: CBPeripheralManagerDelegate {
    ...
    //MARK: Really complicated update state handling (wow proper code)
    ...
    func peripheralManager(_ peripheral: CBPeripheralManager, central: CBCentral, didSubscribeTo characteristic: CBCharacteristic) {
        ...
        // Get the data
        dataToSend = String(sliderValue.value).data(using: .utf8)!
    ...
    func peripheralManager(_ peripheral: CBPeripheralManager, didReceiveWrite requests: [CBATTRequest]) {
        for aRequest in requests {
            ...
            self.sliderValue.value = Float(stringFromData)!
        }
    }
}
